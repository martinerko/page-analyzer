(function() {
    ...
    var docType = (function() {
        ...
        **/
        ...
        var _docType = function(docOrString) {
            ...
            var strDocType = typeof docOrString == "string" ? docOrString : docTypeFromDom(docOrString);
    ...
    function dataProvider(wnd) {
        ...
        that = {
            ...
            frameworks: function() {
                ...
                for (var k in g) {
                    if (k.indexOf("dw_") !== -1) {
                        ret.push["Dynamic Web Coding at www.dyn-web.com"] = 1;
                    }
                }
            ...
            analytics: function() {
                ...
                for (var k in g) {
                    ...
                    } else if (k.indexOf("gemius") !== -1 || k.indexOf("ghmxy_") !== -1) {
                        r.gemius = 1;
    ...
    function analyzer(dataProvider) {
        ...
        function msg(level, txt, extra) {
            return {
                status: levels[level] || levels[levels.length - 1],
                msg: txt,
                extra: extra
            };
        }
        ...
        */
        var security = {
            ...
            "External Scripts (Domain, Host)": function() {
                ...
                var msgs = [msg(what.length ? 1 : 0, str("%0 Scripts Pointing outside of your host has been found", [what.length]), what)];
                if (what.length) {
            ...
            "Client Banners": function() {
                var banners = [],
                    metas = _dp._d().getElementsByTagName("META");
        ...
        var markup = {
            ...
            "CSS Classes": function() {
                ...
                var c, countOfConventions = 0,
                    conventions = detectConventions(uniqueClassNames);
                for (c in conventions)
                    if (conventions[c]) countOfConventions++;
            ...
            "Inline Event Handlers": function() {
                //return [msg(0, "NOT IMPLEMENTED")];
                var what = _dp.getInlineHandlers(),
                    of = _dp.countBodyAll(),
                    perc = Math.ceil(what.length * 100 / of),
                    // TODO: nicer ?
                    uniques = [],
